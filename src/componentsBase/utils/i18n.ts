import isomorphicLocalstorage from "./isomorphicLocalstorage";
...
export const getLanguage = (langs = langsDefault) => {
  ...
  const langLocalStorage = isomorphicLocalstorage.getItem("lang");
  return (langLocalStorage || langFound).toLowerCase();
};

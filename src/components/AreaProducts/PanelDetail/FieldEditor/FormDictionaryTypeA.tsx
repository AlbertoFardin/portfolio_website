...
interface IFormDictionaryTypeA extends IForm {
...
const FormDictionaryTypeA = ({
  ...
  }, [dictionaryId, dictionaryType, search, searchText]);
...
export default FormDictionaryTypeA;
